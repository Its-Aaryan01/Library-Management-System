...
<head>
    ...
    <style>
        ...
        body:before {
            ...
            width: 100%;
            height: 100%;
            background: radial-gradient(circle at 20% 30%, rgba(0, 150, 136, 0.05) 0%, transparent 20%),
                        radial-gradient(circle at 80% 70%, rgba(0, 121, 107, 0.05) 0%, transparent 20%);
...
<body>
    ...
    <ul>
        <li><a href="student_books.php">View Available Books and request</a></li>
        <li><a href="issued_books.php">View Issued Books</a></li>
    </ul>
